...
const AddFrom = ({ handleProduct, title }) => {
	const { products } = data;
	return (
		<form className="grid grid-cols-1 gap-3 mt-10" onSubmit={handleProduct}>
			...
			<div className="flex gap-3">
				...
				<input
					type="file"
					className="file-input file-input-error file-input-ghost  bg-white w-full max-w-xs"
				/>
